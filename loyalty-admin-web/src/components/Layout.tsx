...
const navigation = [
  ...
  { name: 'Business Settings', href: '/business', icon: Building2 },
  { name: 'Manage Users', href: '/users', icon: Users },
  { name: 'Theme Designer', href: '/theme', icon: Palette },
  { name: 'Loyalty Rankings', href: '/rankings', icon: Trophy },
  { name: 'Point Tiers', href: '/point-tiers', icon: Award },
  { name: 'Points Management', href: '/points', icon: Star },
  { name: 'Menu Management', href: '/menu', icon: ShoppingBag },
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <span className="ml-3 text-lg font-semibold text-gray-900">Loyalty Admin</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
